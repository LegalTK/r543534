...
LUA_FUNCTION_GETTER(GetAnimFixEnabled, Bool, globals::shouldFixAnimations);
...
LUA_FUNCTION(UpdateClientSideAnimations) {
	GET_PLAYER(1);
	LUA->CheckNumber(2);

	LUA->PushBool(detours::updateClientSideAnimations(Ply, LUA->GetNumber(2), true));
...
GMOD_MODULE_OPEN() {
	...
	LUA->CreateTable();
		...
		PushApiFunction("GetAnimFixEnabled", GetAnimFixEnabled);
		...
		PushApiFunction("UpdateClientSideAnimations", UpdateClientSideAnimations);
